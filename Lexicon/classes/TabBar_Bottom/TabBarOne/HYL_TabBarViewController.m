...
- (void)setupChildViewControllers
{
    ...
    [self setupChildViewController:mainView title:@"首页" imageName:@"home" selectedImageName:@"homeSelect"];
    
    UIViewController *mediuVC = [[UIViewController alloc]init];
    [self setupChildViewController:mediuVC title:@"本地" imageName:@"local" selectedImageName:@"localSelect"];
    
    MineViewController *mineVC = [[MineViewController alloc]init];
    [self setupChildViewController:mineVC title:@"我的" imageName:@"mine" selectedImageName:@"mineSelect"];
}
